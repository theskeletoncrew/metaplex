...
//         followers and contributors. However, the candy-machine doesn&apos;t have
//         the ability to grant early minting to a whitelisted subset of wallets
//         while also using the same asset configuration for open launch.
//       </div>
...
//           Saber
//         </HyperLink>
//         ) solves both these issues by building a space-efficient hash structure
//         (the merkle tree) such that an on-chain program can validate whether the
//         user is part of a whitelist. Moreover, Gumdrop allows creators to
//         directly send whitelisted users an airdrop reclamation link by building
//         the tree with off-chain handles (e.g email, discord, etc) and allowing
//         the user to redeem into any wallet.
//       </div>
//     </Stack>
//   );
/*
...
// const claim = (
//   <Stack spacing={1}>
//     <Link to={`/gumdrop/claim`}>CLAIMS</Link>
